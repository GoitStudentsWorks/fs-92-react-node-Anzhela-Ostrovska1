import{n as u,r as w,p as Ct,g as Zt,e as en,f as tn,a as re,R as ze,j as a,N as Ve,h as nn,i as xe,k as X,l as Et,s as Xe,b as rn,L as on,m as Z,o as an,q as sn,B as cn,t as ln,v as jt,w as dn}from"./index-4f74fc4a.js";import{b as un}from"./bg_element_des@1x-82ed4fe0.js";const fn=u.div`
  padding: 8px 20px;
...
`,It=["January","February","March","April","May","June","July","August","September","October","November","December"],Io=e=>It[e-1],zo=e=>{const t=w.useRef(null);return w.useEffect(()=>{const n=r=>{t.current&&!t.current.contains(r.target)&&e()};return document.addEventListener("click",n,!0),()=>{document.removeEventListener("click",n,!0)}},[e]),t},Oe={sm:68,md:74},$o={sm:5,md:10},Me={md:69,xl:56},Fe=(e,t)=>{const n=e/$o[t],r=Math.floor(n);switch(t){case"sm":return r===n?parseInt(n-1)*Oe[t]-12:parseInt(n)*Oe[t]-12;case"md":return r===n?parseInt(n-1)*Oe[t]:parseInt(n)*Oe[t];default:return 0}},ft=(e,t)=>{const[n,r]=e%10===0?[9,!1]:[e%10-1,e%10<5];return r?n*Me[t]+Me[t]/4:n*Me[t]-280+Me[t]/4},qo=u.div`
  position: absolute;
  left: 50%;
  top: -194px;
  transform: translate(
...
`;Ye.setAppElement("#root");function Ut({onClose:e}){const[t,n]=w.useState(0),[r,o]=w.useState(!1),[s,l]=w.useState(0),i=re(),[d,f]=w.useState(Date()),{year:h,month:p}=Ne(),g=(T,E="")=>{let k=new Date(d);switch(E){case"hour":k.setHours(parseInt(T.target.value,10));break;case"minute":k.setMinutes(Math.ceil(parseInt(T.target.value,10)/5)*5);break}f(k)},y=()=>{i(an({amount:t,date:new Date(d)})).then(()=>i(xe({year:h,month:p}))).then(e)},M=()=>{n(t+50),l(t+50)},P=()=>{if(t-50<0){n(0),l(0);return}n(t-50),l(t-50)},C=()=>{n(s)},D=T=>{const{value:E}=T.target;if(E==="")l("");else{let k=parseInt(E,10);k=isNaN(k)||k<0?0:k,l(k)}},S=T=>{T.target.closest("#selectTimeWrapper")||(o(!1),T.target===T.currentTarget&&e())},A=w.useCallback(()=>{},[e]);w.useEffect(()=>(window.addEventListener("keydown",A),()=>{window.removeEventListener("keydown",A)}),[A]);const W=T=>{const E=new Date(T),k=_=>_.toString().padStart(2,"0");return`${k(E.getHours())}:${k(E.getMinutes())}`};return ze.createPortal(a.jsx(sa,{onClick:S,children:a.jsxs(ca,{children:[a.jsx(la,{onClick:e,children:a.jsx(da,{width:"24",height:"24",children:a.jsx("use",{href:`${q}#icon-close`})})}),a.jsx(ua,{children:"Add water"}),a.jsx(bt,{children:"Choose a value:"}),a.jsx(vt,{children:"Amount of water:"}),a.jsxs(ga,{children:[a.jsx(yt,{onClick:P,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${q}#icon-minus`})})}),a.jsx(ma,{children:a.jsxs(wt,{children:[t,"ml"]})}),a.jsx(yt,{onClick:M,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${q}#icon-plus`})})})]}),a.jsx(vt,{children:"Recording time:"}),r?a.jsx(Yt,{onChange:g,value:d}):a.jsx(fa,{type:"text","aria-label":"Choose time",value:W(d),onChange:()=>{},onFocus:()=>o(!0)}),a.jsx(bt,{children:"Enter the value of the water used:"}),a.jsx(pa,{value:s,onBlur:C,onChange:D}),a.jsxs(xa,{children:[a.jsxs(wt,{children:[t,"ml"]}),a.jsx(ha,{onClick:y,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const ba=u.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Pa=u.p`
  ...
  line-height: 125%;
  color: #2f2f2f;
`;Ye.setAppElement("#root");function Da({onClose:e}){const t=X(No),[n,r]=w.useState(t.amount),[o,s]=w.useState(!1),[l,i]=w.useState(t.amount),d=re(),[f,h]=w.useState(t.date),{year:p,month:g}=Ne(),y=(E,k="")=>{let _=new Date(f);switch(k){case"hour":_.setHours(parseInt(E.target.value,10));break;case"minute":_.setMinutes(Math.ceil(parseInt(E.target.value,10)/5)*5);break}h(_)},M=()=>{if(n<1)return Ve.Notify.failure("The amount of water should be no less than 1 ml.");d(sn({_id:t.id,amount:n,date:new Date(f)})).then(()=>d(xe({year:p,month:g}))).then(e)},P=()=>{r(n+50),i(n+50)},C=()=>{if(n-50<0){r(0),i(0);return}r(n-50),i(n-50)},D=()=>{r(l)},S=E=>{const{value:k}=E.target;if(k==="")i("");else{let _=parseInt(k,10);_=isNaN(_)||_<0?0:_,i(_)}},A=E=>{E.target.closest("#selectTimeWrapper")||(s(!1),E.target===E.currentTarget&&e())},W=w.useCallback(()=>{},[e]);w.useEffect(()=>(window.addEventListener("keydown",W),()=>{window.removeEventListener("keydown",W)}),[W]);const T=E=>{const k=new Date(E),_=le=>le.toString().padStart(2,"0");return`${_(k.getHours())}:${_(k.getMinutes())}`};return ze.createPortal(a.jsx(ba,{onClick:A,children:a.jsxs(va,{children:[a.jsx(ya,{onClick:e,children:a.jsx("svg",{width:"24",height:"24",children:a.jsx("use",{href:`${q}#icon-close`})})}),a.jsx(wa,{children:"Edit the entered amount of water"}),a.jsxs(Ea,{children:[" ",a.jsx("svg",{width:"36",height:"36",children:a.jsx("use",{href:`${q}#icon-glass`})}),a.jsxs(ja,{children:[t.amount,"ml"]}),a.jsx(Pa,{children:T(t.date)})]}),a.jsx(At,{children:"Correct entered data:"}),a.jsx(Ot,{children:"Amount of water:"}),a.jsxs(ka,{children:[a.jsx(Mt,{onClick:C,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${q}#icon-minus`})})}),a.jsx(Sa,{children:a.jsxs(St,{children:[n,"ml"]})}),a.jsx(Mt,{onClick:P,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${q}#icon-plus`})})})]}),a.jsx(Ot,{children:"Recording time:"}),o?a.jsx(Yt,{onChange:y,value:f}):a.jsx(Aa,{type:"text","aria-label":"Choose time",value:T(f),onChange:()=>{},onFocus:()=>s(!0)}),a.jsx(At,{children:"Enter the value of the water used:"}),a.jsx(Oa,{value:l,onBlur:D,onChange:S}),a.jsxs(Ca,{children:[a.jsxs(St,{children:[n,"ml"]}),a.jsx(Ma,{onClick:M,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const Ta=u.div`
  padding: 0 24px 32px;
`,Na=u.div`
  display: flex;
  flex-direction: column;
...
`,qa="/fs-92-react-node-Anzhela-Ostrovska1/assets/glass-00cf2fb8.svg",Ya="/fs-92-react-node-Anzhela-Ostrovska1/assets/edit-7f0c7b6a.svg",Ua="/fs-92-react-node-Anzhela-Ostrovska1/assets/delete-6bf30e40.svg",Xa=({id:e,amount:t,date:n,onDelete:r,onEdit:o})=>a.jsxs(La,{children:[a.jsxs(Ba,{children:[a.jsx("img",{src:qa,alt:"Icon glass"}),a.jsxs(Ha,{children:[t," ml"]}),a.jsx(Ia,{children:jo(n)})]}),a.jsxs("div",{children:[a.jsx(za,{type:"button",onClick:()=>o({id:e,amount:t,date:n}),children:a.jsx("img",{src:Ya,alt:"Icon glass"})}),a.jsx($a,{type:"button",onClick:()=>r(e),children:a.jsx("img",{src:Ua,alt:"Icon glass"})})]})]},e),Ga=()=>{const[e,t]=w.useState(!1),[n,r]=w.useState(!1),[o,s]=w.useState(""),l=re(),[i,d]=w.useState(!1),f=X(Ue),h=()=>{t(!1)},p=()=>{t(!0)},g=()=>{r(!1)},y=({amount:C,date:D,id:S})=>{r(!0),l(dn({amount:C,date:D,id:S}))},M=()=>{d(!1)},P=C=>{d(!0),s(C)};return a.jsxs("div",{children:[a.jsxs("div",{children:[a.jsx(Va,{children:"Today"}),a.jsxs(Fa,{children:[f.length>0&&f.map(({_id:C,amount:D,date:S})=>a.jsx(Xa,{id:C,amount:D,date:S,onDelete:P,onEdit:y},C)),n&&a.jsx(Da,{isOpen:n,onClose:g})]}),i&&a.jsx(_a,{isShow:i,onClose:M,id:o})]}),a.jsxs(Ra,{type:"button",onClick:p,children:[a.jsx(aa,{})," Add Water"]}),e&&a.jsx(Ut,{isOpen:e,onClose:h})]})},Qa=Ga;function Ka(e){return qt({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"circle",attr:{cx:"12",cy:"12",r:"10"},child:[]},{tag:"line",attr:{x1:"12",y1:"8",x2:"12",y2:"16"},child:[]},{tag:"line",attr:{x1:"8",y1:"12",x2:"16",y2:"12"},child:[]}]})(e)}const Ja=u.div`
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
